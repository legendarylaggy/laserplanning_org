...
app.post('/submitInfo', (req, res) => {
  ...
  var connection = new sql.ConnectionPool(config, (err) => {
    ...
    reqData.order.split('+').forEach((element, i, arr) => {
      ...
      var query = 'SELECT [Job_Operation].[Sched_Start] as value FROM [dbo].[Job_Operation] where Job like ' + fetch + '  AND ( [Work_Center] = N\'FIBER 3030\' OR [Work_Center] = N\'LASER-6KW\' OR [Work_Center] = N\'LASER-5040\' ) '
